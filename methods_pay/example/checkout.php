...
if(file_exists('../../includes/db_config.php') == TRUE)
{
	...
	if($installed == '1')
	{
		...
		//Page Content
		$smarty->assign('page_name', 'Checkout');
		$smarty->assign('long_descrip', "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please review your order and shipping information and after confirming that all items and information are correct use the button below to checkout your items. <br><br>
		...
		//$smarty->display('category_top.tpl');
				...
				else
				{
					...
					$smarty->assign('cartid',$cartid); //CartID
